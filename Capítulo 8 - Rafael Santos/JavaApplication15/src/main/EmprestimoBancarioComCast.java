...
/**
 * A classe EmprestimoBancarioComCast, que calcula o valor de empréstimos que
 * podem ser dados a pessoas (instâncias das classes Pessoa, Funcionario e
 * ChefeDeDepartamento) por um banco popular. Esta classe é similar à classe
 * EmprestimoBancario, mas o método calculaEmpréstimo unifica o cálculo do
 * empréstimo que pode ser feito verificando a classe da instância passada como
 * argumento e fazendo o cast (conversão explícita) se necessário.
 */
class EmprestimoBancarioComCast {
     ...
     * uma pessoa (instância da classe Funcionario e suas descendentes). O
     * empréstimo será calculado de forma diferenciada para as instâncias das
     * classes Funcionario e ChefeDeDepartamento.
     *
    ...
    public static float calculaEmpréstimo(Pessoa p) {
        ...
        if (p instanceof ChefeDeDepartamento) {
            ...
            // ela será somente outra referência à p.
