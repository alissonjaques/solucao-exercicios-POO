...
public class Data {// declaração da classe
    ...
    /**
     * O método inicializaData recebe argumentos para inicializar os campos da
     * classe Data. Este método chama o método dataÉVálida para verificar se os
     * argumentos correspondem a uma data válida: se forem, inicializa os
     ...
     */
    /**
     * public void inicializaData(byte d,byte m,short a){ if
     * (dataÉVálida(d,m,a)){// se a data for válida, inicializa os campos com os
     * // valores passados como argumentos dia = d; mês = m; ano = a; } else {
     * // caso contrário, inicializa os campos com zero
     *
     * dia = 0; mês = 0; ano = 0; } } // fim do método inicializaData
     */
    /**
    ...
    public boolean éIgual(Data outraData) {
        ...
        // a data é igual, retorna true
        // a data é diferente, retorna false
